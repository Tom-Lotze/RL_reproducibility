...
def plot_action_value(action_value_grid):
    ...
    top_value_positions = [(0.38,0.25),(1.38,0.25),(2.38,0.25),(3.38,0.25),(4.38,0.25),
                           ...
                           (0.38,2.25),(1.38,2.25),(2.38,2.25),(3.38,2.25),(4.48,2.25),
                           (0.38,3.25),(1.38,3.25),(2.38,3.25),(3.38,3.25),(4.48,3.25),
                           (0.38,4.25),(1.38,4.25),(2.38,4.25),(3.38,4.25),(4.48,4.25)]
    
    right=action_value_grid[:,1].reshape((5,5))
    ...
    bottom=action_value_grid[:,2].reshape((5,5))
    ...
    left=action_value_grid[:,3].reshape((5,5))
